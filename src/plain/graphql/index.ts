...
export type GetAllWorkspaceUsersQuery = { __typename?: 'Query', users: { __typename?: 'UserConnection', edges: Array<{ __typename?: 'UserEdge', node: { __typename?: 'User', id: string, email: string, fullName: string } }> } };
...
export const GetAllWorkspaceUsersDocument = gql`
  ...
  users(first: 100) {
    ...
    `;
export const UpsertCustomTimelineEntryDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    upsertCustomTimelineEntry(variables: UpsertCustomTimelineEntryMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data: UpsertCustomTimelineEntryMutation; extensions?: unknown; headers: Dom.Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<UpsertCustomTimelineEntryMutation>(UpsertCustomTimelineEntryDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'upsertCustomTimelineEntry', 'mutation');
    },
    upsertCustomer(variables: UpsertCustomerMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data: UpsertCustomerMutation; extensions?: unknown; headers: Dom.Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<UpsertCustomerMutation>(UpsertCustomerDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'upsertCustomer', 'mutation');
    }
  };
}
